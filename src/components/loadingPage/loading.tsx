      ...
      <div className="border-animation">
        ...
        >
          ...
          <defs>
            ...
            <g id="cat">
              <circle fill="#00a47e" cx="1115" cy="625" r="25"></circle>
              <path
                fill="#FFF"
                stroke="#00a47e"
                stroke-width="3"
            ...
            <g id="cap">
              ...
              <line
                ...
                y2="816.4"
              />
              <circle fill="#00a47e" cx="429.4" cy="777.4" r="2" />
              <circle fill="#00a47e" cx="462.4" cy="777.4" r="2" />
            </g>
            <g id="ball">
              <circle
                fill="#FFF"
            ...
            <g id="plane">
              ...
              <use className="helix" filter="url(#f1)"></use>
              <line
                fill="none"
                className="stroke"
                x1="728"
          ...
          <use className="box" x="20" y="30"></use>
          <use className="parachute" x="20" y="-112"></use>
          <rect fill="white" x="320" y="310" width="665" height="238"></rect>
          <use className="tshirt"></use>
          <use className="cap" y="-150"></use>
          <use className="ball" y="-140"></use>
          <use className="sky-circle" x="-10px" y="5"></use>
          <use className="sky-circle2" x="500px" y="-125"></use>
          <use className="sky-circle3" x="1000px" y="50"></use>
          <use className="cloud" x="0" y="10"></use>
          <use className="plane" y="-80"></use>

          <use className="cloud2" x="0" y="130"></use>
          <use className="trees" x="40" y="0"></use>
          <circle
            ...
            r="23"
          ></circle>
          <use className="cat" x="15" y="5"></use>
          <g id="browser">
            <path
              fill="none"
              className="stroke"
          ...
          <g id="toldo">
            ...
            />
            <use className="tol" x="-250"></use>
            <use className="tol" x="334"></use>
            <use className="tol" x="417"></use>
            <line
              className="stroke round-end"
              x1="277"
              y1="470.5"
          ...
          <g id="door">
            ...
            />
            <rect fill="#00a47e" x="730" y="700" width="225" height="15"></rect>
            <g id="sign">
              <polyline
                fill="none"
                className="stroke"
          ...
          <use className="grass" x="130" y="0"></use>
          <rect
            className="grass"
            x="130"
            y="850"
